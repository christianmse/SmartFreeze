...
public class DespensaAdapter2 extends RecyclerView.Adapter<DespensaAdapter2.Holder> {
    private ArrayList<Producto> listaProductos;
    private Context context;
    private RecyclerView.RecycledViewPool viewPoll;
    IDespensaListener listener;

    public DespensaAdapter2(Context context,ArrayList<Producto> listaProductos, IDespensaListener listener ){
    ...
    @Override
    public void onBindViewHolder(@NonNull DespensaAdapter2.Holder holder, int position) {
